...
CREATE TABLE `jianmu_engine_future` (
    `id` int NOT NULL AUTO_INCREMENT,
    `uuid` varchar(45) NOT NULL,
    `transaction_id` bigint NOT NULL,
    `type` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `priority` int NOT NULL,
    `cron` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci COMMENT ='计划任务表';